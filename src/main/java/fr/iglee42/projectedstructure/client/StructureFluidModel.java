...
public final class StructureFluidModel implements IModelGeometry<StructureFluidModel>
{
    public static final StructureFluidModel WATER = new StructureFluidModel(Fluids.WATER);
    public static final StructureFluidModel LAVA = new StructureFluidModel(Fluids.LAVA);

    private final Fluid fluid;

    public StructureFluidModel(Fluid fluid)
    {
        this.fluid = fluid;
    }
